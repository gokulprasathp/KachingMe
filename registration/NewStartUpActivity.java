...
import com.wifin.kachingme.adaptors.OfferAdapterNew;
...
public class NewStartUpActivity extends Activity {
	...
	String mobileno;
	String TAG = NewStartUpActivity.class.getSimpleName();
...
//	LinearLayout f_headlay;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// View.inflate(NewStartUpActivity.this, R.layout.activity_start_up,vg);
		inialize();
		screenArrange();
//		sideMenufoot.setVisibility(LinearLayout.GONE);
		...
		context = NewStartUpActivity.this;
		setActivitystage("NewStartUpActivity");
		...
		if (Constant.freelistmain.size() > 0) {
			Constant
					.prtMsg("size ::: >>>>" + Constant.freelistmain.size());
			...
			listdata.setAdapter(new OfferAdapterNew(NewStartUpActivity.this,
					Constant.freelistmain, getResources(), myMap));

		} else {

			AlertDialog.Builder builder1 = new AlertDialog.Builder(
					NewStartUpActivity.this);
		...
		f_next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (Constant.spinnerList.size() > 0) {
					Set<Entry<String, SpinnerValue>> setMap = Constant.hm
							.entrySet();
					...
					if (myValuearray.size() == 1) {
						Intent intent = new Intent(NewStartUpActivity.this,
								StartUpDescription.class);
	...
	private void setActivitystage(String newStartUpActivity) {
		// TODO Auto-generated method stub
		editor = sharedpreferences.edit();
		editor.putString("activity_name", newStartUpActivity);
...
//		f_headlay = (FrameLayout) findViewById(R.id.freebie_headlayout);
	...
	private void initiatePopupWindow() {
		try {
			...
			LayoutInflater inflater = (LayoutInflater) NewStartUpActivity.this
			...
			btn_submit_popup.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					Constant
							.prtMsg("finalSpinnervalue=btn_submit_popup;::"
									+ finalSpinnervalue);
					int spin = 0;
					if (finalSpinnervalue != null) {
						...
						Toast.makeText(NewStartUpActivity.this,
