...
public class UiLifecycleHelper {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			String callIdString = savedInstanceState
					.getString(DIALOG_CALL_ID_SAVE_KEY);
			if (callIdString != null) {
				pendingFacebookDialogCallId = UUID.fromString(callIdString);
			}
			pendingFacebookDialogCallStore
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data,
		...
		if (LikeActionController.handleOnActivityResult(activity, requestCode,
				resultCode, data)) {
			return;
		}
	...
	public void onSaveInstanceState(Bundle outState) {
		...
		if (pendingFacebookDialogCallId != null) {
			outState.putString(DIALOG_CALL_ID_SAVE_KEY,
					pendingFacebookDialogCallId.toString());
		}
	...
	private boolean handleFacebookDialogActivityResult(int requestCode,
		...
		FacebookDialog.PendingCall pendingCall = pendingFacebookDialogCallStore
				.getPendingCallById(pendingFacebookDialogCallId);
		...
		if (callId != null && pendingFacebookDialogCallId.equals(callId)) {
			...
			FacebookDialog.handleActivityResult(activity, pendingCall,
					requestCode, data, facebookDialogCallback);
		} else {
	...
	private void cancelPendingAppCall(
		...
		if (facebookDialogCallback != null) {
			...
			FacebookDialog.handleActivityResult(activity, pendingCall,
					pendingCall.getRequestCode(), cancelIntent,
					facebookDialogCallback);
		}
	...
	private void stopTrackingPendingAppCall() {
		pendingFacebookDialogCallStore
				.stopTrackingPendingCall(pendingFacebookDialogCallId);
