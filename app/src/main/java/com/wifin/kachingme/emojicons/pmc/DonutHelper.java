package com.wifin.kachingme.emojicons.pmc;
...
class DonutHelper extends PopupMenuCompat {
	...
	public void show() {
		...
		builder.setItems(titles.toArray(new CharSequence[titles.size()]),
				new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int which) {
						DialogMenu.DialogMenuItem item = (DialogMenu.DialogMenuItem) enabled
								.get(which);

						if (menuItemClickListener == null
								&& item.menuItemClickListener != null) {
