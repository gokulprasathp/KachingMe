 ...
 */
public class EmojiconEditTextDynamic extends EditText {
	private int mEmojiconSize;

	public EmojiconEditTextDynamic(Context context) {
		super(context);
		mEmojiconSize = 40;

	}

	public EmojiconEditTextDynamic(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs);
	}
