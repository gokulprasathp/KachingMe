...
/**
 * A subclass of {@link android.view.View} class for creating a custom circular
 * progressBar
 * 
...
public class CircleProgressBar extends View {
	...
	/**
	 * Transparent the given color by the factor The more the factor closer to
	 * zero the more the color gets transparent
	 * 
	 * @param color
	...
	/**
	 * Set the progress with an animation. Note that the
	 * {@link android.animation.ObjectAnimator} Class automatically set the
	 * progress so don't call the {@link CircleProgressBar#setProgress(float)}
	 * directly within this method.
	 * 
	 * @param progress
	 *            The progress it should animate to it.
	 */
