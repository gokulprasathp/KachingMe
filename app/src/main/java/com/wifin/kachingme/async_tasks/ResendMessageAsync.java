            ...
            if (contact.getIs_niftychat_user() == 1
                ...
                try {
                    ...
                    if (TempConnectionService.connection != null) {
                        ...
                        chat =  TempConnectionService.chatmanager.createChat(JidCreate.entityBareFrom(msg.getKey_remote_jid()),
            ...
            } else try {
                {
                    ...
                    MultiUserChat multiUserChat = multiUserChatManager
                            .getMultiUserChat(JidCreate.entityBareFrom(msg.getKey_remote_jid()));
                    // Group messages ...
                    if (msg.getMedia_wa_type().equals("0")) {
