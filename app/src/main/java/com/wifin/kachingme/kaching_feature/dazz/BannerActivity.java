...
public class BannerActivity extends Activity implements OnTouchListener,
    ...
    public boolean onTouch(View v, MotionEvent event) {
        // TODO Auto-generated method stub
//		startActivity(new Intent(BannerActivity.this, DazzPlainActivity.class));
        finish();
        return true;
    }
...
//		startActivity(new Intent(BannerActivity.this, DazzPlainActivity.class));
    ...
    class MyGameView extends SurfaceView implements Runnable {
        ...
        public void run() {
            int previewX = 0;
            int previewY = (int) ((((double) BannerActivity.this.screen7over8) / 4.0d) - (((double) BannerActivity.this.previewHeight) / 2.0d));
            if (BannerActivity.this.previewHeight > ((int) (((double) BannerActivity.this.screen7over8) / 2.0d))) {
                previewX = 0;
                previewY = 0;
            }
            ...
            try {
                ...
                if (Constant.shapeselected.equalsIgnoreCase("Circle")) {
                    inputStream2 = BannerActivity.this.getApplicationContext()
            ...
            this.back2 = Bitmap.createScaledBitmap(temp2,
                    BannerActivity.this.previewWidth,
                    BannerActivity.this.previewHeight, false);
            if (temp2 != this.back2) {
                temp2.recycle();
            }

            BannerActivity.this.paint = new Paint();
            BannerActivity.this.paint.setDither(true);
            BannerActivity.this.paint.setFilterBitmap(true);
            BannerActivity.this.paint.setTypeface(Typeface.create(
                    Typeface.SANS_SERIF, 1));
            this.textSize = (int) ((BannerActivity.this.zeroPointValue / 3.0f) * ((float) BannerActivity.this.previewHeight));
            BannerActivity.this.paint.setTextSize((float) this.textSize);
            BannerActivity.this.lengthPM = (int) BannerActivity.this.paint
                    .measureText(BannerActivity.this.printMessage);
            /** this for starting of lead on middle */
            BannerActivity.this.moveX = 0;
            BannerActivity.this.moveYFixed = ((int) (((float) (BannerActivity.this.previewHeight / 2)) - ((BannerActivity.this.paint
                    .descent() + BannerActivity.this.paint.ascent()) / 2.0f)))
                    + previewY;
            boolean isBlinkerSwitcher = true;
            int blinkerCounter = 0;
            /** this for starting of lead */
            if (BannerActivity.this.movementType == 0) {
                if (BannerActivity.this.lengthPM >= BannerActivity.this.screenWidth) {
                    BannerActivity.this.moveX = 0;
                } else {
                    BannerActivity.this.moveX = (BannerActivity.this.screenWidth / 2)
                            - (BannerActivity.this.lengthPM / 2);
                }
            } else if (BannerActivity.this.movementType == 1) {
                if (BannerActivity.this.lengthPM >= BannerActivity.this.screenWidth) {
                    BannerActivity.this.moveX = BannerActivity.this.lengthPM;
                } else {
                    BannerActivity.this.moveX = (BannerActivity.this.screenWidth / 2)
                            - (BannerActivity.this.lengthPM / 2);
                }
            } else if (BannerActivity.this.movementType == 2) {
                if (BannerActivity.this.lengthPM >= BannerActivity.this.screenWidth) {
                    BannerActivity.this.moveX = BannerActivity.this.screenWidth;
                } else {
                    BannerActivity.this.moveX = (BannerActivity.this.screenWidth / 2)
                            - (BannerActivity.this.lengthPM / 2);
                }
                ...
                if (canvas != null) {
                    try {
                        synchronized (this.mHolder) {
                            BannerActivity.this.paint.setColor(-16777216);
                            canvas.drawRect(0.0f, 0.0f,
                                    (float) BannerActivity.this.screenWidth,
                                    (float) BannerActivity.this.screenHeight,
                                    BannerActivity.this.paint);
                            this.textSize = (int) ((BannerActivity.this.zeroPointValue / 3.0f) * ((float) BannerActivity.this.previewHeight));
                            BannerActivity.this.paint
                                    .setTextSize((float) this.textSize);
                            BannerActivity.this.moveYFixed = ((int) (((float) (BannerActivity.this.previewHeight / 2)) - ((BannerActivity.this.paint
                                    .descent() + BannerActivity.this.paint
                                    .ascent()) / 2.0f)))
                                    + previewY;
                            BannerActivity.this.lengthPM = (int) BannerActivity.this.paint
                                    .measureText(BannerActivity.this.printMessage);
                            BannerActivity.this.paint
                                    .setColor(Color
                                            .parseColor(BannerActivity.this.backroundColor));
                            canvas.drawRect(
                                    (float) previewX,
                                    (float) previewY,
                                    (float) (BannerActivity.this.previewWidth + 0),
                                    (float) (BannerActivity.this.previewHeight + previewY),
                                    BannerActivity.this.paint);
                            BannerActivity.this.paint
                                    .setColor(Color
                                            .parseColor(BannerActivity.this.inputTextColor));
                            if (BannerActivity.this.isBlinker) {
                                ...
                                if (isBlinkerSwitcher) {
                                    ...
                                    canvas.drawText(
                                            BannerActivity.this.printMessage,
                                            (float) BannerActivity.this.moveX,
                                            (float) BannerActivity.this.moveYFixed,
                                            BannerActivity.this.paint);
                                } else {
                            ...
                            canvas.drawBitmap(this.back2, (float) previewX,
                                    (float) previewY, BannerActivity.this.paint);
                            if (BannerActivity.this.movementType != 0) {
                                BannerActivity BannerActivity;
                                if (BannerActivity.this.movementType == 1) {
                                    if (BannerActivity.this.screenWidth >= BannerActivity.this.moveX) {
                                        BannerActivity = BannerActivity.this;
                                        BannerActivity.moveX = BannerActivity.moveX
                                                + BannerActivity.this.movementDeltaX;
                                    } else {
                                        BannerActivity.this.moveX = -BannerActivity.this.lengthPM;
                                    }
                                } else if (BannerActivity.this.movementType == 2) {
                                    if (BannerActivity.this.moveX >= (-BannerActivity.this.lengthPM)) {
                                        BannerActivity = BannerActivity.this;
                                        BannerActivity.moveX = BannerActivity.moveX
                                                - BannerActivity.this.movementDeltaX;
                                    } else {
