...
public class SmackThatGroup extends MainActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		back.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(SmackThatGroup.this,
		...
		mRecordingSend.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Constant.karaokegroup = true;
				Constant.filegroup = outputFile;
				Intent in = new Intent(SmackThatGroup.this, MUCTest.class);
				startActivity(in);
				finish();
			}
		});
		...
		mKaroakePlay.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (mPause == true) {
					...
					try {
						mediaPlayer.setDataSource(SmackThatGroup.this, mp3);
						mediaPlayer.prepare();
						mediaPlayer.start();
	...
	public void onBackPressed() {
		...
		Intent intent = new Intent(SmackThatGroup.this, KaraokeMainGroup.class);
		startActivity(intent);
		finish();
	}
