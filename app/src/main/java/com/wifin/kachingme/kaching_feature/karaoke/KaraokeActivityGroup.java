...
public class KaraokeActivityGroup extends MainActivity {
	...
	Intent intent;
    public static KaraokeActivityGroup mActivity;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		back.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(KaraokeActivityGroup.this,
						KaraokeMainGroup.class);
		...
		mRecordingSend.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				com.wifin.kachingme.util.Constant.karaokegroup = true;
				com.wifin.kachingme.util.Constant.filegroup = outputFile;
				Intent in = new Intent(KaraokeActivityGroup.this,
						MUCTest.class);
				startActivity(in);
				finish();
			}
		...
		mKaroakePlay.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (mPause == true) {
					...
					try {
						mediaPlayer.setDataSource(KaraokeActivityGroup.this,
								mp3);
						mediaPlayer.prepare();
						mediaPlayer.start();
