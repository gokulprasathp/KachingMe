...
* @author Sivaprasath
*
* @usage -  This class is used to display the Buxs Points
*
*
* */
...
public class BuxsPointAdapter extends BaseAdapter {

    int height, width;
    ArrayList<BuxsEarnedDto> mList = new ArrayList<BuxsEarnedDto>();
    SharedPreferences sp;
    private Context context;
    private LayoutInflater inflater;

    public BuxsPointAdapter(Context context, ArrayList mFilmNameTextList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.yearstext.setText(mList.get(position).getName());

        holder.nametext.setText(mList.get(position).getAcheive());
