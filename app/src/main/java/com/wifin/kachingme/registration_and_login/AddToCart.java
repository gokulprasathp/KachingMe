...
public class AddToCart extends AppCompatActivity {
    ...
    byte img_byte[];
    String TAG = AddToCart.class.getSimpleName();
    String mobileno;
    ...
    Editor editor;
    // WebView web_View;
FreebieActivity mNewStartUp = new FreebieActivity();
    @Override
...
//
//				Intent i = new Intent(AddToCart.this,
...
//		siva
        ...
        mAddToCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Connectivity.isConnected(AddToCart.this)) {
                    ...
                    CommonMethods com = new CommonMethods(AddToCart.this);
                    com.okDialogBox(AddToCart.this, getResources().getString(
    ...
    private void setActivitystage(String addToCart) {
        // TODO Auto-generated method stub
        editor = sharedpreferences.edit();
        editor.putString("activity_name", addToCart);
    ...
    private void inialize() {
        ...
        Constant.typeFace(this,mCompanyName);
        Constant.typeFace(this,mProductName);
        Constant.typeFace(this,mProdValidity);
        Constant.typeFace(this,mWebLink);
        Constant.typeFace(this,mHeader);
        Constant.typeFace(this,mAddToCart);
    ...
    private String jsonForm() {
        ...
        String description=Constant.freelistmain.get(Constant.newstlistpos)
                .getFreebilist().get(Constant.spinnerpos).getTagLine();
        ...
        dataCart = new Gson().toJson(l);

        Constant.printMsg("order cart name ::::" + dataCart.toString());
        return dataCart;
    }
    ...
    public class posId extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            Constant.printMsg("result dis post id" + KachingMeConfig.CART_URL + data);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null && result.length() > 0) {
                ...
                ca.setCompanyname(Constant.freelistmain.get(
                        Constant.newstlistpos).getCompanyName());
                ca.setValidity(Constant.freelistmain.get(Constant.newstlistpos)
                        .getFreebilist().get(Constant.spinnerpos)
                        .getValid_untilSrt());
                ...
                cv.put("validity",
                        Constant.freelistmain.get(Constant.newstlistpos)
                                .getFreebilist().get(Constant.spinnerpos)
                                .getValid_untilSrt());
                //cv.put("validity",sp.getString("ExpiryDate",""));
                cv.put("offer", " Free");
                cv.put("prodname",
                        Constant.freelistmain.get(Constant.newstlistpos)
                                .getFreebilist().get(Constant.spinnerpos)
                ...
                Intent intent = new Intent(AddToCart.this,
                        StartUpDazz.class);
    ...
    public void onBackPressed() {
        startActivity(new Intent(AddToCart.this, FreebieActivity.class));
        finish();
    }
