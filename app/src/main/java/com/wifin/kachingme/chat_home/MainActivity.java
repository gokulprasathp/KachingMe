...
public class MainActivity extends FragmentActivity {
	...
	public static LinearLayout headlay, datalay, ctlay, bglay, cotlay, stlay,
			setcount_lay, sideMenufoot;
	public static ImageView logo, back, chatimg, bugsimg, contimg, settimg;
	public static LinearLayout cart;
	public static int width, height;
	public static TextView cartno, cttext, bgtext, cottext, stext,
			setcount_txt,head, right_head, next;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// if (tabletSize) {
		// CommonMethods
		// .prtMsg("inside test vino tabletSize in slidertesting::"
		// + tabletSize);
		ScreenArragne();
		// } else {
		// Constant.printMsg("mobile::::::in main activity::::");
		// screenArrange();
		// }
		String first = "Ka";
		...
		ctlay.setOnClickListener(new View.OnClickListener() {
		...
		bglay.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// Intent i = new Intent(SliderTesting.this, BuxActivity.class);
				Intent i = new Intent(MainActivity.this, BuxSActivity.class);
				startActivity(i);
				finish();
		...
		stlay.setOnClickListener(new View.OnClickListener() {
...
//				finish();
		...
		cotlay.setOnClickListener(new View.OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(MainActivity.this, DealsActivity.class);
				startActivity(i);
				finish();
			}
		});
	...
	private void screenArrange() {
		...
		LinearLayout.LayoutParams backlay = new LinearLayout.LayoutParams(
				LinearLayout.LayoutParams.WRAP_CONTENT,
				LinearLayout.LayoutParams.MATCH_PARENT);
		backlay.width = width * 6 / 100;
		backlay.height = width * 6 / 100;
