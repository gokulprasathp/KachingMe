...
import com.wifin.kachingme.registration_and_login.RegisterActivity;

import java.util.ArrayList;

public class CountryNew extends ArrayAdapter<CountryCodeGetSet> {
	...
	public CountryNew(RegisterActivity activitySpinner, int textViewResourceId,
